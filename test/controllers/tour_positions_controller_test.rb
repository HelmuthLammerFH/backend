...
class TourPositionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour_position" do
    assert_difference('TourPosition.count') do
      post tour_positions_url, params: { tour_position: { changedFrom: @tour_position.changedFrom, createdFrom: @tour_position.createdFrom, name: @tour_position.name, position: @tour_position.position, syncedFrom: @tour_position.syncedFrom } }
    end
  ...
  test "should update tour_position" do
    patch tour_position_url(@tour_position), params: { tour_position: { changedFrom: @tour_position.changedFrom, createdFrom: @tour_position.createdFrom, name: @tour_position.name, position: @tour_position.position, syncedFrom: @tour_position.syncedFrom } }

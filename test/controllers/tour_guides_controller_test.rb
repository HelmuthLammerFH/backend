...
class TourGuidesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour_guide" do
    assert_difference('TourGuide.count') do
      post tour_guides_url, params: { tour_guide: { changedFrom: @tour_guide.changedFrom, createdFrom: @tour_guide.createdFrom, deleteFlag: @tour_guide.deleteFlag, joomlaID: @tour_guide.joomlaID, syncedFrom: @tour_guide.syncedFrom, tourGuideSince: @tour_guide.tourGuideSince } }
    end
  ...
  test "should update tour_guide" do
    patch tour_guide_url(@tour_guide), params: { tour_guide: { changedFrom: @tour_guide.changedFrom, createdFrom: @tour_guide.createdFrom, deleteFlag: @tour_guide.deleteFlag, joomlaID: @tour_guide.joomlaID, syncedFrom: @tour_guide.syncedFrom, tourGuideSince: @tour_guide.tourGuideSince } }

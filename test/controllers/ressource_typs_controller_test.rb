...
class RessourceTypsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ressource_typ" do
    assert_difference('RessourceTyp.count') do
      post ressource_typs_url, params: { ressource_typ: { changedFrom: @ressource_typ.changedFrom, createdFrom: @ressource_typ.createdFrom, deleteFlag: @ressource_typ.deleteFlag, name: @ressource_typ.name, syncedFrom: @ressource_typ.syncedFrom } }
    end
  ...
  test "should update ressource_typ" do
    patch ressource_typ_url(@ressource_typ), params: { ressource_typ: { changedFrom: @ressource_typ.changedFrom, createdFrom: @ressource_typ.createdFrom, deleteFlag: @ressource_typ.deleteFlag, name: @ressource_typ.name, syncedFrom: @ressource_typ.syncedFrom } }

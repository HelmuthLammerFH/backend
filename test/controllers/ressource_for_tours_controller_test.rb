...
class RessourceForToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ressource_for_tour" do
    assert_difference('RessourceForTour.count') do
      post ressource_for_tours_url, params: { ressource_for_tour: { RessourceTyp_id: @ressource_for_tour.RessourceTyp_id, Tour_id: @ressource_for_tour.Tour_id, changedFrom: @ressource_for_tour.changedFrom, createdFrom: @ressource_for_tour.createdFrom, deleteFlag: @ressource_for_tour.deleteFlag, picture: @ressource_for_tour.picture, syncedFrom: @ressource_for_tour.syncedFrom } }
    end
  ...
  test "should update ressource_for_tour" do
    patch ressource_for_tour_url(@ressource_for_tour), params: { ressource_for_tour: { RessourceTyp_id: @ressource_for_tour.RessourceTyp_id, Tour_id: @ressource_for_tour.Tour_id, changedFrom: @ressource_for_tour.changedFrom, createdFrom: @ressource_for_tour.createdFrom, deleteFlag: @ressource_for_tour.deleteFlag, picture: @ressource_for_tour.picture, syncedFrom: @ressource_for_tour.syncedFrom } }
